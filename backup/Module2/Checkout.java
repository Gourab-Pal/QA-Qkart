...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> addressElements = driver.findElements(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']"));
    ...
    public Boolean placeOrder() {
        try {
            ...
            WebElement checkoutButton = driver.findElement(By.xpath("//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButtonBase-root  css-177pwqq']"));
